...
const KNOWN_SECRETS = ['BETTER_AUTH_SECRET', 'R2_ACCOUNT_ID', 'R2_ACCESS_KEY_ID', 'R2_SECRET_ACCESS_KEY', 'SAP_TOKEN_URL', 'SAP_CLIENT_ID', 'SAP_CLIENT_SECRET', 'SAP_API_BASE', 'SAP_WEBHOOK_SECRET'];
